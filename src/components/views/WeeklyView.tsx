 ...
 * Projects with Kanban board for activities
 */
...
import { Plus, ChevronLeft, ChevronRight, FolderKanban, Calendar, Target, Eye, EyeOff, X, GraduationCap, Dumbbell, Briefcase, Palette, Heart, Sparkles, Users2, Users } from "lucide-react";
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          >
            ...
            {state.showPastItems ? "Ocultar pasados" : "Ver todos"}
          </Button>
